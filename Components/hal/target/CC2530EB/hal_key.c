...
#define HAL_KEY_JOY_MOVE_PORT   P0//microdjg
//#define HAL_KEY_JOY_MOVE_BIT    BV(0)
#define HAL_KEY_JOY_MOVE_BIT    BV(7)//microdjg
...
/* edge interrupt */
#define HAL_KEY_JOY_MOVE_EDGEBIT  BV(7)
...
#define HAL_KEY_JOY_MOVE_ICTLBIT  BV(7) /* P0IENL - enable/disable bit */
#define HAL_KEY_JOY_MOVE_PXIFG    P0IFG /* Interrupt flag at source */

#define HAL_KEY_JOY_MOVE_PICTL    PICTL//microdjg
...
void HalKeyInit( void )
{
  ...
  HAL_KEY_JOY_MOVE_DIR &= ~(HAL_KEY_JOY_MOVE_BIT); /* Set pin direction to Input */
  HAL_KEY_JOY_MOVE_PICTL |=0x01;//P0 falling interrupt
...
uint8 HalKeyRead ( void )
{
  ...
  if ((HAL_KEY_JOY_MOVE_PORT & HAL_KEY_JOY_MOVE_BIT))  /* Key is active low */
  {
    ...
    //keys |= halGetJoyKeyInput();//MICRODJG
    keys = halGetJoyKeyInput();
  }
...
void HalKeyPoll (void)
{
  ...
  else
  {
    ...
    if ((HAL_KEY_JOY_MOVE_PORT | (~HAL_KEY_JOY_MOVE_BIT))==(~HAL_KEY_JOY_MOVE_BIT))  /* Key is active LOW *///microdjg
    {
      keys=HAL_KEY_INT_1;
    }
  }
...
HAL_ISR_FUNCTION( halKeyPort0Isr, P0INT_VECTOR )
{
  if (HAL_KEY_JOY_MOVE_PXIFG & HAL_KEY_JOY_MOVE_BIT)//ÖÐ¶Ï±ê¼Ç
  {
    halProcessKeyInterrupt();
  }
  /*
