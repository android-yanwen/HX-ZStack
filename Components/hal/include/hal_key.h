...
/*Key Interrupt*///MICRODJG
#define HAL_KEY_INT_1	0xE1	//Interrupt KEY 1	
#define HAL_KEY_INT_2	0xE2	//Interrupt KEY 2	
#define HAL_KEY_INT_3	0xE3	//Interrupt KEY 3	
#define HAL_KEY_INT_4	0xE4	//Interrupt KEY 4
  
/* ADC KEY *///MICRODJG
#define HAL_KEY_UP     0xA0  // Joystick up
#define HAL_KEY_RIGHT  0xA1  // Joystick right
#define HAL_KEY_CENTER 0xA2  // Joystick center
#define HAL_KEY_LEFT   0xA3  // Joystick left
#define HAL_KEY_DOWN   0xA4  // Joystick down
