...
#include "hal_uart.h"//microdjg
#include "OnBoard.h"//microdjg
/*********************************************************************
 * MACROS
 */
 ...
 */
  ...
  const char ZigbeeCoordStr[]  = "GTA ZigBee Coord";
...
void nwk_Status( uint16 statusCode, uint16 statusValue )
{
   ...
   switch ( statusCode )
  {
    case NWK_STATUS_COORD_ADDR:
        ...
        HalUARTWrite(HAL_UART_PORT_0,"1",1);//microdjg
        #endif
        break;

    case NWK_STATUS_ROUTER_ADDR:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"2",1);//microdjg
        #endif
        break;

    case NWK_STATUS_ORPHAN_RSP:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"3",1);//microdjg
        #endif
        break;

    case NWK_ERROR_ASSOC_RSP:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"4",1);//microdjg
        #endif
        break;

    case NWK_STATUS_ED_ADDR:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"5",1);//microdjg
        #endif
        break;

    case NWK_STATUS_PARENT_ADDR:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"6",1);//microdjg
        #endif
        break;

    case NWK_STATUS_ASSOC_CNF:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"7",1);//microdjg
        #endif
        break;

    case NWK_ERROR_ASSOC_CNF_DENIED:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"8",1);//microdjg
        #endif
        SystemReset();
        break;
    ...
    case NWK_ERROR_ENERGY_SCAN_FAILED:
        #if defined (GTA_DEBUG)  
        HalUARTWrite(HAL_UART_PORT_0,"9",1);//microdjg
        #endif
        break;
  }
 */
