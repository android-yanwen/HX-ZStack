 ...
 */
   ...
   #include "TransmitApp.h"//microdjg
extern byte TransmitApp_TaskID;//microdjg
...
void ZDO_NetworkFormationConfirmCB( ZStatus_t Status )
{
  ...
  if ( Status == ZSUCCESS )
  {
    ...
    ///////osal_start_timerEx( TransmitApp_TaskID, TRANSMITAPP_BIND_REQUEST_EVT,3000 );//×Ô¶¯¿ªÊ¼°ó¶¨ microdjg
